...
class Milog_Ticket
{
    ...
    public function saveTicketDataOnOrder( $orderId, $tickets )
    {
        foreach( $tickets as $store => $data ){
            $keysMap = [
                'id'        => '_' . $store . '_ticket_id',
                'protocol'  => '_' . $store . '_ticket_protocol',
                'status'    => '_' . $store . '_ticket_status',
                'created_at'=> '_' . $store . '_ticket_created_at',
                'updated_at'=> '_' . $store . '_ticket_updated_at'
            ];
